...
const Footer = () => {
  ...
  return (
    <footer className="py-12">
      {!isCartPage ? (
        <>
          <div className="container border-t mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-4 lg:px-0">
            <div className="">
              <h3 className="text-lg text-gray-800 font-bold mb-4 uppercase">
                Newsletter
              </h3>
            ...
            <div className="grid justify-center">
              <h3 className="text-lg text-gray-800 mb-4 font-bold uppercase">
                Shop
              </h3>
